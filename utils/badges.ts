...
export const BADGES: Badge[] = [
  ...
  { id: 'stone',   emoji: '🪨', label: 'Stone',   description: '5 species',   threshold: 5,   color: '#9E9E9E' },
  { id: 'spark',   emoji: '⚡', label: 'Spark',   description: '10 species',  threshold: 10,  color: '#FFC107' },
  { id: 'bloom',   emoji: '🌸', label: 'Bloom',   description: '25 species',  threshold: 25,  color: '#F06292' },
  { id: 'wing',    emoji: '🦋', label: 'Wing',    description: '50 species',  threshold: 50,  color: '#9C27B0' },
  { id: 'wave',    emoji: '🌊', label: 'Wave',    description: '75 species',  threshold: 75,  color: '#29B6F6' },
